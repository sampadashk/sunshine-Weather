...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String metric=context.getString(R.string.value_cel);
        SharedPreferences sp= PreferenceManager.getDefaultSharedPreferences(context);
        String preferedval=sp.getString(context.getString(R.string.unitkey),context.getString(R.string.unitdefault));
        if(preferedval.equals(metric)) {
            /** This will be implemented in a future lesson **/
            return true;
        }
        return false;
