...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler,SharedPreferences.OnSharedPreferenceChangeListener {
   ...
   public static Boolean prefChanged;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvw=(RecyclerView) findViewById(R.id.recyclerview_forecast);
        forecastAdapter=new ForecastAdapter(res,this);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(getBaseContext());
        rvw.setLayoutManager(layoutManager);
        rvw.setHasFixedSize(true);
        rvw.setAdapter(forecastAdapter);
    ...
    private void showErrorMessage() {
        ...
        rvw.setVisibility(View.INVISIBLE);
        /* Then, show the error */
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
      prefChanged=SunshinePreferences.isMetric(this);
        res.clear();
        String location = SunshinePreferences.getPreferredWeatherLocation(this);
        new FetchWeatherTask().execute(location);
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
               ...
               for (String weatherString : weatherData) {
                  ...
                  res.add(weatherString);
                }
                Log.d("chkweather"," "+res);
